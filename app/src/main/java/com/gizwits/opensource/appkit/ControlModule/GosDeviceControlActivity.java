...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_DeviceOnOff;
	private TextView tv_data_TempSet;
	private SeekBar sb_data_TempSet;
	private TextView tv_data_TempNow;
	...
	private void initView() {
		...
		sw_bool_DeviceOnOff = (Switch) findViewById(R.id.sw_bool_DeviceOnOff);
		tv_data_TempSet = (TextView) findViewById(R.id.tv_data_TempSet);
		sb_data_TempSet = (SeekBar) findViewById(R.id.sb_data_TempSet);
		tv_data_TempNow = (TextView) findViewById(R.id.tv_data_TempNow);
	}

	private void initEvent() {

		sw_bool_DeviceOnOff.setOnClickListener(this);
		sb_data_TempSet.setOnSeekBarChangeListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_DeviceOnOff:
			sendCommand(KEY_DEVICEONOFF, sw_bool_DeviceOnOff.isChecked());
			break;
		default:
			break;
		}
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		case R.id.sb_data_TempSet:
			tv_data_TempSet.setText(formatValue((progress + TEMPSET_OFFSET) * TEMPSET_RATIO + TEMPSET_ADDITION, 1));
			break;
		default:
			break;
		}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		switch (seekBar.getId()) {
		case R.id.sb_data_TempSet:
			sendCommand(KEY_TEMPSET, (seekBar.getProgress() + TEMPSET_OFFSET ) * TEMPSET_RATIO + TEMPSET_ADDITION);
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_DeviceOnOff.setChecked(data_DeviceOnOff);
		tv_data_TempSet.setText(data_TempSet+"");
		sb_data_TempSet.setProgress((int)((data_TempSet - TEMPSET_ADDITION) / TEMPSET_RATIO - TEMPSET_OFFSET));
		tv_data_TempNow.setText(data_TempNow+"");
